...
int valor = 0;
int B, SP, SE, SA;
int conta=0, paradas = 0;

void __attribute__((picinterrupt(("")))) TrataInt()
{
    if(INTF)
    {
        INTCONbits.INTF = 0;
...
int main(void)
{
    ...
    while(1)
    {
        ...
        if (B != 127)
        {
                Lcd_Clear();
                Lcd_Set_Cursor(1,1);
                Lcd_Write_String("PESO DO MOINHO");
                _delay((unsigned long)((100)*(4000000/4000.0)));
            if(B > 127){
                    Lcd_Set_Cursor(2,1);
        ...
        if(SP != 127)
        {
                Lcd_Clear();
                Lcd_Set_Cursor(1,1);
                Lcd_Write_String("ESTADO DO PORTAO");
                _delay((unsigned long)((1000)*(4000000/4000.0)));
                Lcd_Set_Cursor(2,1);
                Lcd_Write_String("ABERTO");
                _delay((unsigned long)((1000)*(4000000/4000.0)));
                __asm("clrwdt");
        }
        else if(SP == 127)
        ...
        if(SE != 127)
        {
                Lcd_Clear();
                Lcd_Set_Cursor(1,1);
                Lcd_Write_String("ESTADO DA ESCOTILHA");
                _delay((unsigned long)((100)*(4000000/4000.0)));
                if(SE > 127){


                    Lcd_Set_Cursor(2,1);
                    Lcd_Write_String("ESCOTILHA: ABERTA");
                    _delay((unsigned long)((1000)*(4000000/4000.0)));
        ...
        if(SA != 127 && B != 127)
        {
            Lcd_Clear();
            Lcd_Set_Cursor(1,1);
            Lcd_Write_String("NIVEL DA AGUA");
            _delay((unsigned long)((100)*(4000000/4000.0)));
            if(SA > 127)
            {
